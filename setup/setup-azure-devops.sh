...
az pipelines variable-group create \
  ...
  --variables azureSubscription=$ADO_SC_NAME hostPoolName=$DEV_HPOOL_NAME resourceGroup=$DEV_RG storageAccount=$AVD_STRG_NAME msixAppAttachUNCLocalPath='c:\avdmsix' msixApplicationUNCServer=fileshare.domain.onmicrosoft.com msixApplicationUNCShareName=avdmsix \
  --authorize true \
